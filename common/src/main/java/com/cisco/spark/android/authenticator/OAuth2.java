...
public class OAuth2 {
    ...
    public static final String CONVERSATION_SCOPES = Strings.join(" ", "webexsquare:get_conversation", OOB_SCOPE);
    public static final String KMS_SCOPES = "spark:kms";
    public static final String UBER_SCOPES = Strings.join(" ", CONVERSATION_SCOPES, KMS_SCOPES, VM_SCOPES);
    ...
    public Response<OAuth2AccessToken> getVoicemailTokens(OAuth2Client oAuth2Client, OAuth2AccessToken tokens) throws IOException {
        return reduceScope(oAuth2Client, tokens, VM_SCOPES, clientId, clientSecret);
    }
