...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
    ...
    /**
     * Sets executor to AsyncTask.THREAD_POOL_EXECUTOR and Handler to new Handler()
     */
    ...
    /**
     * Sets executor to AsyncTask.THREAD_POOL_EXECUTOR
     */
    ...
    public boolean cancel(boolean mayInterruptIfRunning) {
        if (future == null) {
            Ln.i("Canceling a task before future() was called");
            return true;
        }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        ...
        protected void postToUiThreadAndWait(final Callable c) throws Exception {
            ...
            if (Looper.myLooper() == Looper.getMainLooper()) {
                Ln.e("postToUiThreadAndWait() error: Already on UI thread.");
            }
