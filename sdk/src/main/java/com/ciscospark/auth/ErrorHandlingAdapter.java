...
/**
 * Custom CallAdapter which adapts the built-in Call to {@link ErrorHandlingCall}
 * whose callback {@link ErrorHandlingCallback} has more network error reports methods.
 */
final class ErrorHandlingAdapter {
    /** A callback which offers granular callbacks for various conditions. */
    interface ErrorHandlingCallback<T> {
    ...
    public static class ErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
        @Override public CallAdapter<ErrorHandlingCall<?>> get(Type returnType, Annotation[] annotations,
                                                               Retrofit retrofit) {
    ...
    /** Adapts a Call to {@link ErrorHandlingCall}. */
    static class ErrorHandlingCallAdapter<T> implements ErrorHandlingCall<T> {
        ...
        @Override public void enqueue(final ErrorHandlingCallback<T> callback) {
        ...
        @Override public ErrorHandlingCall<T> clone() {
